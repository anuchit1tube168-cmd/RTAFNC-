...
for(const token of [
  ...
  'renderOps','renderAgents','renderWork','renderTraining','renderSignals','renderCandidate','renderWorld','startWorldLoop','CORE_PIXEL_SPECS','SHIP_STATIONS','SHIP_ROOM_BOUNDS','queueShipRoute','separateActors','corridorLaneFor','focusShipRoom','renderShipHud','ROOM_META',

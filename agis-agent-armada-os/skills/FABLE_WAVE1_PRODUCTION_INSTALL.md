...
Target:
AGIS Crew Dashboard static prototype / GitHub Pages
...
## Note
Only `SKILL.md` entry points are installed in this PR. Support files from the package remain available in Google Drive and can be added after first successful receipts.
